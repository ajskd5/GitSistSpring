          ...
          <td>
            <c:forEach var="rvo" items="${rList }">
              <table class="table">
                <tr>
                  <td class="text-left">
                    <%-- 댓글이면 tab만큼 공백 주고 댓글표시 --%>
                    <c:if test="${rvo.group_tab > 0 }">
                      <c:forEach var="i" begin="1" end="${rvo.group_tab }">
                        &nbsp;&nbsp;
                      </c:forEach>
                      <img src="../goods/re_icon.gif">
                    </c:if>
                  ...
                  <td class="text-right">
                    <c:if test="${sessionScope.id != null }">
                      ...
                      <span class="btn btn-xs btn-info re" data-no="${rvo.no }" id="re${rvo.no }">댓글</span>
                    </c:if>
                  </td>
                </tr>
                <tr>
                  <td colspan="2"> <%-- 댓글 내용 출력 --%>
	            ...
	            <tr>
	              <td>
	                <form method="post" action="../reply/reply_update.do">
	                  ...
	                  <input type="submit" value="댓글수정" style="height: 106px; float: left" class="btn btn-sm btn-danger">
	                </form>
	              </td>
	            </tr>
	          </table>
	            ...
	            <tr>
	              <td>
	                <form method="post" action="../reply/reply_reply_insert.do">
	                  ...
	                  <input type="submit" value="댓글달기" style="height: 106px; float: left" class="btn btn-sm btn-danger">
	                </form>
	              </td>
	            </tr>
	          </table>
          ...
          <tr>
            <td>
              <form method="post" action="../reply/reply_insert.do">
                ...
                <input type="submit" value="댓글쓰기" style="height: 106px; float: left" class="btn btn-sm btn-danger">
              </form>
            </td>
          </tr>
        </table>
