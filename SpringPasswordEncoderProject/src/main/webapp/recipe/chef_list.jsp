                ...
                <tr>
                  <td width="30%" class="text-center" rowspan="2">
                    <a href="../recipe/chef_detail.do?no=${vo.no }">
                      <img src="${vo.poster }" style="width: 150px; height: 120px;" class="img-circle">
                    </a>
                  </td>
                  <td width="70%" colspan="4"><h3> <a href="../recipe/chef_detail.do?no=${vo.no }">${vo.chef }</a></h3></td>
                </tr>
                <tr>
                  <td class="text-center"><img src="../recipe/mc1.jpg">&nbsp;${vo.mem_cont1 }</td>
                  <td class="text-center"><img src="../recipe/mc3.jpg">&nbsp;${vo.mem_cont3 }</td>
                  <td class="text-center"><img src="../recipe/mc7.jpg">&nbsp;${vo.mem_cont7 }</td>
                  <td class="text-center"><img src="../recipe/mc2.jpg">&nbsp;${vo.mem_cont2 }</td>
                </tr>
              </table>
            </c:forEach>
          </td>
